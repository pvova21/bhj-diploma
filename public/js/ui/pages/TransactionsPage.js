...
class TransactionsPage {
  ...
  removeAccount() {
    if (this.lastOptions) {
      if (window.confirm("Вы хотите удалить счет?")) {
        this.clear();
  ...
  getTransactionHTML(item){
    let trnsType;
    item.type === 'income' ? trnsType = 'transaction_income' : trnsType = 'transaction_expense';
    return (
      `<div class="transaction ${trnsType} row">
